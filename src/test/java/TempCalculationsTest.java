...
class TempCalculationsTest{
    ...
    @Test
    void celsiusToFahrenheitMenu(){
        //Arrange
        Menues menu = new Menues();
        //Act
        String text = menu.celsiusToFahrenheit();
        //Asserts
        assertTrue(text.contains("degrees of Fahrenheit"));
    }
    @Test
    void fahrenheitToCelsiusMenu(){
        //Arrange
        Menues menu = new Menues();
        //Act
        String text = menu.fahrenheitToCelsius();
        //Asserts
        assertTrue(text.contains("degrees of Celsius"));
    }
}